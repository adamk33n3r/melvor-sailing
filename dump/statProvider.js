  ...
  applyDataModification(data, game) {
    ...
    try {
      if (data.modifiers !== undefined) {
        const newModifiers = game.modifyModifierValues(
          (_a = this.modifiers) !== null && _a !== void 0 ? _a : [],
          data.modifiers,
        );
        if (newModifiers.length === 0) this.modifiers = undefined;
        else this.modifiers = newModifiers;
      }
      if (data.enemyModifiers !== undefined) {
        const newModifiers = game.modifyEnemyModifierValues(
          (_b = this.enemyModifiers) !== null && _b !== void 0 ? _b : [],
          data.enemyModifiers,
        );
        if (newModifiers.length === 0) this.enemyModifiers = undefined;
        else this.enemyModifiers = newModifiers;
      }
      if (data.combatEffects !== undefined) {
        ...
        if (this.combatEffects.length === 0) this.combatEffects = undefined;
      }
      if (data.conditionalModifiers !== undefined) {
        ...
        if (newConditionals.length === 0) this.conditionalModifiers = undefined;
        else this.conditionalModifiers = newConditionals;
      }
    } catch (e) {
...
class StatProvider {
  ...
  addStatObject(source, stats, negMult = 1, posMult = 1) {
    if (stats.modifiers !== undefined) this.modifiers.addModifiers(source, stats.modifiers, negMult, posMult);
...
class StatObjectSummary {
  ...
  getAllDescriptions() {
    ...
    this.combatEffects.forEach((applicator) => {
      ...
      if (desc !== undefined) descriptions.push(desc);
    });
